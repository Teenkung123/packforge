...
| Production nonblank LOC | 16,471 |
| Bridge files | 107 |
| Bridge LOC | 5,451 (33.09%) |
| Exact duplicate groups | 0 |
| Normalized duplicate groups | 0 |
| Target/version conditional lines | 15 |
| Stonecutter conditional blocks | 6 (maximum 40 lines) |
| Renderer bodies | 3 |
| Renderer adapters | 2 |
| Registry publication artifacts | 20 |

Baseline was 212 production files and 16,837 LOC with 20 normalized duplicate groups. Current source has two additional production files, removes all measured duplicate groups, and is 366 LOC lower, a 2.17% raw LOC reduction. It does not meet a 20-25% raw shrink target; added registry, compatibility, validation, and reporter capabilities must remain explicitly justified rather than recast as shrink proof.
