...
| Source metrics | 214 production Java files; 16,471 LOC; 107 bridge files / 5,451 LOC (33.09%); zero exact/normalized duplicate groups; 15 target/version conditional lines; six Stonecutter conditional blocks (maximum 40 lines); three renderer bodies; two adapters. |
