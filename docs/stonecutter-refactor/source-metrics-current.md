...
| Metric | Value |
|---|---:|
| Production Java files | 202 |
| Production nonblank LOC | 16209 |
| Bridge files | 99 |
| Bridge LOC | 5426 (33.48%) |
...
|---|---:|---:|
| `neutralCommon` | 60 | 5929 |
| `versionCommon` | 46 | 4959 |
| `loaderCommon` | 18 | 671 |
| `exactVersionBridge` | 78 | 4650 |
...
| `FONT_PROVIDER_PRESELECTION` | `common/src/main/java/com/teenkung/packforge/config/FeaturePolicy.java` | `com/teenkung/packforge/client/font/FontOptimizationState.class`<br>`com/teenkung/packforge/client/font/FontSelectionRegistry.class` | `client:font.FontManagerMixin`<br>`client:font.FontSetMixin` |
...
| `RELOAD_SUMMARY_TOAST` | `common/src/main/java/com/teenkung/packforge/config/FeaturePolicy.java` | None | `client-any:ui.LoadingOverlayMixin`<br>`client-any:ui.LoadingOverlayToastMixin` |
