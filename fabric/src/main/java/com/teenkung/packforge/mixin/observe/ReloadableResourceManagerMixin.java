...
public abstract class ReloadableResourceManagerMixin {
	...
	private ReloadInstance packforge$createReload(Executor preparationExecutor, Executor reloadExecutor,
		CompletableFuture<Unit> initialStage, List<PackResources> packs, Operation<ReloadInstance> original) {
