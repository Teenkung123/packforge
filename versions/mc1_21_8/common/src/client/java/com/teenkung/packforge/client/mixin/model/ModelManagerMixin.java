...
public abstract class ModelManagerMixin {
	...
	private CompletableFuture<Map<ResourceLocation, UnbakedModel>> packforge$loadModels(
		ResourceManager manager,
		Executor executor,
		Operation<CompletableFuture<Map<ResourceLocation, UnbakedModel>>> original
	) {
