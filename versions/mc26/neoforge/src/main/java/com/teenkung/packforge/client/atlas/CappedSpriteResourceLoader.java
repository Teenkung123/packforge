...
/** Delegates to vanilla so NeoForge sprite hooks stay authoritative. */
public final class CappedSpriteResourceLoader implements SpriteResourceLoader {
	...
	@Override
	public SpriteContents loadSprite(Identifier spriteLocation, Resource resource, SpriteContentsConstructor constructor) {
		return SpriteMetadataCache.withAtlas(state, () -> delegate.loadSprite(spriteLocation, resource, constructor));
	}
}
