...
public final class ReloadSummaryToast implements Toast {
	...
	private static final class LiveToast implements Toast {
		...
		@Override public Visibility render(GuiGraphics graphics, ToastComponent component, long timeSinceVisible) {
			if (this.hidden || liveToast != this || !ReloadStatus.externalFeedbackEnabled() || !ReloadStatus.isActive()) return Visibility.HIDE;
