...
public abstract class SpaceProviderDefinitionCodecMixin {
	@WrapOperation(method = "*", require = 1, allow = 1, at = @At(value = "INVOKE",
		target = "Lcom/mojang/serialization/codecs/UnboundedMapCodec;fieldOf(Ljava/lang/String;)Lcom/mojang/serialization/MapCodec;"))
	private static MapCodec<Map<Integer, Float>> packforge$boundedAdvanceDecoding(
		UnboundedMapCodec<Integer, Float> codec, String field,
		Operation<MapCodec<Map<Integer, Float>>> original) {
